...
if __name__ == '__main__':
    ...
    outfile = '/users/a/r/areagan/fun/twitter/scraping/data/{0:019d}-{1:019d}.json'.format(numCompleted,numCompleted+numToGrab-1)
    outlog = '/users/a/r/areagan/fun/twitter/scraping/log/{0:019d}-{1:019d}.log'.format(numCompleted,numCompleted+numToGrab-1)
